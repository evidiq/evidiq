...
export default function sitemap(): MetadataRoute.Sitemap {
  ...
  return [
    ...
    { url: `${base}/docs/operator`, lastModified: now, changeFrequency: "weekly", priority: 0.8 },
    { url: `${base}/docs/sentinel`, lastModified: now, changeFrequency: "weekly", priority: 0.8 },
    { url: `${base}/docs/atlas`, lastModified: now, changeFrequency: "weekly", priority: 0.8 },
